...
-- Dumping data for table datn.address: ~8 rows (approximately)
INSERT INTO `address` (`AddressID`, `UserID`, `RecipientName`, `RecipientPhone`, `AddressDetails`, `IsDefault`) VALUES
	(6, 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', 1),
	(7, 9, 'a11', '111', 'đ', 1),
	(8, 10, 'biển', '000', 'đà nẵng', 1),
	(9, 12, 'biển', '0373802893', 'đà nẵng', 1),
	(10, 14, 'a', '11', 'đà nẵng', 1),
	(11, 16, 'biên', '11111', 'đà nẵng', 1),
	(12, 17, '1', '3', 'dn', 1),
	(13, 19, '1', '1', '1', 1);

-- Dumping data for table datn.banner: ~4 rows (approximately)
...
-- Dumping data for table datn.cart: ~8 rows (approximately)
...
-- Dumping data for table datn.cartitem: ~7 rows (approximately)
...
-- Dumping data for table datn.category: ~21 rows (approximately)
INSERT INTO `category` (`CategoryID`, `CategoryName`, `ParentCategoryID`, `ImagePath`) VALUES
	(1, 'Áo Nam đẹp', NULL, 'https://iili.io/JR4gFGs.md.png'),
	...
	(16, 'Tất Nam đẹp', 15, 'https://iili.io/J5HwxTu.jpg'),
	(18, 'Áo đông', 1, 'https://iili.io/JR4gFGs.md.png'),
	(21, 'áo xuân', NULL, 'https://iili.io/JR4gFGs.md.png'),
	(22, 'áo hồng đẹp', 21, 'https://iili.io/JR4gFGs.md.png'),
	(23, 'áo phông', NULL, 'https://iili.io/JR4gFGs.md.png'),
	(24, 'áo phông mùa hè', 23, 'https://iili.io/JR4gFGs.md.png');

-- Dumping data for table datn.comments: ~3 rows (approximately)
INSERT INTO `comments` (`comment_id`, `content`, `created_at`, `detete`, `product_id`, `user_id`) VALUES
	(9, 'rẻ', 'Fri Nov 29 21:07:11 ICT 2024', b'0', 149, 16),
	(10, 'rẻ', 'Fri Nov 29 21:18:32 ICT 2024', b'0', 63, 16),
	(11, 'đẹp', 'Fri Nov 29 21:33:59 ICT 2024', b'0', 68, 1);

-- Dumping data for table datn.orderdetails: ~36 rows (approximately)
INSERT INTO `orderdetails` (`OrderDetailID`, `OrderID`, `ProductID`, `ProductName`, `SizeName`, `ImagePath`, `ProductPrice`, `Quantity`, `TotalPrice`) VALUES
	(32, 19, 63, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thoáng Khí', 'S', 'https://iili.io/JR4LT5G.jpg', 249000, 1, 249000),
	(33, 20, 63, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thoáng Khí', 'S', 'https://iili.io/JR4LT5G.jpg', 249000, 1, 249000),
	(34, 21, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'S', 'https://iili.io/JR4Qfkb.jpg', 279000, 1, 279000),
	(35, 22, 71, 'Áo Polo Nam, Vải Viscose Mềm Mượt, Thoáng Khí', 'S', 'https://iili.io/JR6foJf.jpg', 389000, 1, 389000),
	(36, 23, 68, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thấm Hút', 'S', 'https://iili.io/JR4tYsp.jpg', 239000, 1, 239000),
	(37, 24, 148, 'Quần lót nam VISCOSE EXTRA SOFT dáng Trunk', 'S', 'https://iili.io/JRDVUcx.jpg', 96000, 1, 96000),
	(38, 25, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'S', 'https://iili.io/JR4Qfkb.jpg', 279000, 1, 279000),
	(39, 26, 96, 'Quần Short Thể Thao Nam, Thoáng Khí, Thấm Hút Mồ Hôi', 'M', 'https://iili.io/JRLD90x.jpg', 389000, 1, 389000),
	(40, 27, 63, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thoáng Khí', 'S', 'https://iili.io/JR4LT5G.jpg', 249000, 1, 249000),
	(41, 28, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'S', 'https://iili.io/JR4Qfkb.jpg', 279000, 1, 279000),
	(42, 29, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'S', 'https://iili.io/JR4Qfkb.jpg', 279000, 1, 279000),
	(43, 30, 65, 'Áo Thun Dài Tay Nam, Mềm Mịn, Bền Bỉ', 'S', 'https://iili.io/JR6Fv3J.jpg', 219000, 1, 219000),
	(44, 30, 65, 'Áo Thun Dài Tay Nam, Mềm Mịn, Bền Bỉ', '2XL', 'https://iili.io/JR6Fv3J.jpg', 219000, 1, 219000),
	(45, 32, 93, 'Quần Short Thể Thao Nam, Cạp Chun, In Chữ Trẻ Trung', 'M', 'https://iili.io/JRLto9S.jpg', 429000, 1, 429000),
	(46, 33, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'M', 'https://iili.io/JR4Qfkb.jpg', 279000, 1, 279000),
	(47, 34, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'S', 'https://iili.io/JR6FGYx.jpg', 279000, 1, 279000),
	(48, 35, 154, 'Tất nhẹ', 's', 'https://iili.io/2cSHaeI.png', 12, 1, 12),
	(49, 36, 93, 'Quần Short Thể Thao Nam, Cạp Chun, In Chữ Trẻ Trung', 'S', 'https://iili.io/JRLto9S.jpg', 429000, 1, 429000),
	(50, 37, 148, 'Quần lót nam VISCOSE EXTRA SOFT dáng Trunk', 'S', 'https://iili.io/JRDVUcx.jpg', 96000, 1, 96000),
	(51, 38, 63, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thoáng Khí', 'M', 'https://iili.io/JR4LT5G.jpg', 249000, 1, 249000),
	(52, 39, 79, 'Áo Polo Nam, Thấm Hút Mồ Hôi Tốt', 'M', 'https://iili.io/JR6n4j4.jpg', 419000, 1, 419000),
	(53, 40, 93, 'Quần Short Thể Thao Nam, Cạp Chun, In Chữ Trẻ Trung', 'S', 'https://iili.io/JRLto9S.jpg', 429000, 1, 429000),
	(54, 41, 155, 'áo lớp', 's', 'https://iili.io/2lb1UFf.png', 12000, 1, 12000),
	(55, 42, 65, 'Áo Thun Dài Tay Nam, Mềm Mịn, Bền Bỉ', 'S', 'https://iili.io/JR6Fv3J.jpg', 219000, 4, 876000),
	(56, 44, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'S', 'https://iili.io/JR4Qfkb.jpg', 279000, 1, 279000),
	(57, 45, 70, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thoáng Khí', 'S', 'https://iili.io/JR4Dqps.jpg', 249000, 1, 249000),
	(58, 46, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'S', 'https://iili.io/JR6FGYx.jpg', 279000, 1, 279000),
	(59, 47, 96, 'Quần Short Thể Thao Nam, Thoáng Khí, Thấm Hút Mồ Hôi', 'M', 'https://iili.io/JRLD90x.jpg', 389000, 1, 389000),
	(60, 50, 44, 'Áo Khoác Phao Nam, Dày Dặn, Cản Gió, Cản Bụi', 'S', 'https://iili.io/JR4DQn4.jpg', 999000, 2, 1998000),
	(61, 51, 68, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thấm Hút', 'S', 'https://iili.io/JR6KY9R.jpg', 239000, 2, 478000),
	(62, 52, 149, 'Áo Thun Nam Ngắn Tay, Thiết Kế In Chuyển Màu Trẻ Trung', 'S', 'https://iili.io/J5HWZ1S.jpg', 329000, 1, 329000),
	(63, 54, 63, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thoáng Khí', 'S', 'https://iili.io/JR6F7h7.jpg', 249000, 2, 498000),
	(64, 55, 149, 'Áo Thun Nam Ngắn Tay, Thiết Kế In Chuyển Màu Trẻ Trung', 'L', 'https://iili.io/J5HWZ1S.jpg', 329000, 1, 329000),
	(65, 56, 64, 'Áo Thun Dài Tay Nam, Thiết Kế Basic', 'S', 'https://iili.io/JR4Qfkb.jpg', 279000, 2, 558000),
	(66, 57, 68, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thấm Hút', 'S', 'https://iili.io/JR6KY9R.jpg', 239000, 3, 717000),
	(67, 58, 65, 'Áo Thun Dài Tay Nam, Mềm Mịn, Bền Bỉ', 'S', 'https://iili.io/JR4Q1CN.jpg', 219000, 1, 219000),
	(68, 59, 70, 'Áo Thun Dài Tay Nam, Mềm Mịn, Thoáng Khí', 'L', 'https://iili.io/JR6Kgcb.jpg', 249000, 1, 249000),
	(69, 60, 149, 'Áo Thun Nam Ngắn Tay, Thiết Kế In Chuyển Màu Trẻ Trung', 'S', 'https://iili.io/J5HWtr7.jpg', 329000, 2, 658000),
	(70, 61, 92, 'Quần Short Thể Thao Nam, Cạp Chun, In Chữ Trẻ Trung', 'M', 'https://iili.io/JRLZkCb.jpg', 429000, 1, 429000);

-- Dumping data for table datn.orders: ~42 rows (approximately)
INSERT INTO `orders` (`OrderID`, `OrderDate`, `TotalAmount`, `OrderStatus`, `UserID`, `RecipientName`, `RecipientPhone`, `AddressDetails`, `payment`) VALUES
	(19, '2024-11-23 21:52:22.890000', 249000, 'Hoàn thành', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', NULL),
	(20, '2024-11-23 22:00:25.305000', 249000, 'Đang giao hàng', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', NULL),
	(21, '2024-11-23 22:01:20.591000', 279000, 'Đã hủy', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', NULL),
	(22, '2024-11-23 22:05:41.109000', 389000, 'Hoàn thành', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', 'Thanh toán online'),
	(23, '2024-11-25 19:04:52.876000', 239000, 'Hoàn thành', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', NULL),
	(24, '2024-11-25 19:06:26.216000', 96000, 'Chờ xác nhận', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', NULL),
	(25, '2024-11-27 16:31:19.899000', 279000, 'Hoàn thành', 9, 'a11', '111', 'đ', NULL),
	(26, '2024-11-29 12:37:34.525000', 389000, 'Đã hủy', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', NULL),
	(27, '2024-11-29 13:52:21.909000', 249000, 'Hoàn thành', 10, 'biển', '000', 'đà nẵng', NULL),
	(28, '2024-11-29 13:52:47.433000', 279000, 'Chờ xác nhận', 1, 'biển', '000', 'đà nẵng', 'Thanh toán online'),
	(29, '2024-11-29 13:53:53.742000', 279000, 'Chờ xác nhận', 1, 'biển', '000', 'đà nẵng', 'Thanh toán online'),
	(30, '2024-11-29 13:55:10.315000', 249000, 'Đã xác nhận', 1, 'biển', '000', 'đà nẵng', 'Thanh toán online'),
	(31, '2024-11-29 13:56:29.239000', 249000, 'Chờ xác nhận', 1, 'biển', '000', 'đà nẵng', NULL),
	(32, '2024-11-29 13:56:38.121000', 429000, 'Chờ xác nhận', 1, 'biển', '000', 'đà nẵng', NULL),
	(33, '2024-11-29 14:35:48.020000', 279000, 'Chờ xác nhận', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', 'Thanh toán online'),
	(34, '2024-11-29 15:49:57.768000', 279000, 'Hoàn thành', 12, 'biển', '0373802893', 'đà nẵng', 'Thanh toán online'),
	(35, '2024-11-29 15:50:26.975000', 12, 'Chờ xác nhận', 1, 'biển', '0373802893', 'đà nẵng', NULL),
	(36, '2024-11-29 15:51:24.660000', 429000, 'Chờ xác nhận', 1, 'biển', '0373802893', 'đà nẵng', 'Thanh toán online'),
	(37, '2024-11-29 15:52:12.384000', 96000, 'Chờ xác nhận', 1, 'biển', '0373802893', 'đà nẵng', 'Thanh toán online'),
	(38, '2024-11-29 15:52:53.109000', 249000, 'Chờ xác nhận', 1, 'biển', '0373802893', 'đà nẵng', 'Thanh toán online'),
	(39, '2024-11-29 15:53:40.454000', 419000, 'Chờ xác nhận', 1, 'biển', '0373802893', 'đà nẵng', 'Thanh toán online'),
	(40, '2024-11-29 15:54:45.126000', 429000, 'Đã xác nhận', 1, 'biển', '0373802893', 'đà nẵng', 'Thanh toán online'),
	(41, '2024-11-29 15:59:47.308000', 12000, 'Hoàn thành', 12, 'biển', '0373802893', 'đà nẵng', NULL),
	(42, '2024-11-29 16:42:31.226000', 876000, 'Hoàn thành', 14, 'a', '11', 'đà nẵng', 'Thanh toán online'),
	(43, '2024-11-29 16:43:49.237000', 1998000, 'Chờ xác nhận', 1, 'a', '11', 'đà nẵng', NULL),
	(44, '2024-11-29 17:25:50.637000', 279000, 'Chờ xác nhận', 1, 'a', '11', 'đà nẵng', 'Thanh toán online'),
	(45, '2024-11-29 17:26:32.568000', 249000, 'Chờ xác nhận', 1, 'a', '11', 'đà nẵng', 'Thanh toán online'),
	(46, '2024-11-29 17:30:45.624000', 279000, 'Chờ xác nhận', 14, 'a', '11', 'đà nẵng', NULL),
	(47, '2024-11-29 17:31:05.686000', 389000, 'Chờ xác nhận', 1, 'a', '11', 'đà nẵng', 'Thanh toán online'),
	(48, '2024-11-29 17:34:10.429000', 192000, 'Chờ xác nhận', 14, 'a', '11', 'đà nẵng', NULL),
	(49, '2024-11-29 17:35:25.297000', 1181000, 'Chờ xác nhận', 14, 'a', '11', 'đà nẵng', NULL),
	(50, '2024-11-29 21:00:21.883000', 1998000, 'Chờ xác nhận', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', NULL),
	(51, '2024-11-29 21:04:56.361000', 478000, 'Chờ xác nhận', 16, 'biên', '11111', 'đà nẵng', NULL),
	(52, '2024-11-29 21:05:20.349000', 329000, 'Chờ xác nhận', 1, 'biên', '11111', 'đà nẵng', 'Thanh toán online'),
	(53, '2024-11-29 21:07:44.116000', 658000, 'Chờ xác nhận', 1, 'biên', '11111', 'đà nẵng', NULL),
	(54, '2024-11-29 21:19:01.168000', 498000, 'Chờ xác nhận', 16, 'biên', '11111', 'đà nẵng', NULL),
	(55, '2024-11-29 21:19:33.046000', 329000, 'Chờ xác nhận', 1, 'biên', '11111', 'đà nẵng', 'Thanh toán online'),
	(56, '2024-11-29 21:22:29.821000', 558000, 'Chờ xác nhận', 1, '1', '3', 'dn', 'Thanh toán online'),
	(57, '2024-11-29 21:34:35.258000', 717000, 'Chờ xác nhận', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', 'Thanh toán online'),
	(58, '2024-11-29 21:40:16.098000', 219000, 'Đang giao hàng', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', NULL),
	(59, '2024-11-29 21:46:52.423000', 249000, 'Đã hủy', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', 'Thanh toán online'),
	(60, '2024-11-29 21:51:03.204000', 658000, 'Đã hủy', 1, 'Ngô Thị Biển', '0989898989', 'Ha Tinh', 'Thanh toán online'),
	(61, '2024-12-02 12:20:57.081000', 429000, 'Đã xác nhận', 19, '1', '1', '1', NULL);

-- Dumping data for table datn.product: ~99 rows (approximately)
INSERT INTO `product` (`ProductID`, `ProductName`, `productPrice`, `ProductDescription`) VALUES
	...
	(154, 'Tất nhẹ', 12, '"Tất nữ" là một loại phụ kiện thời trang được thiết kế dành riêng cho phái nữ, có chức năng bảo vệ và giữ ấm cho đôi chân, đồng thời là một phần quan trọng trong việc hoàn thiện phong cách thời trang. Tất nữ thường được làm từ các chất liệu như cotton, len, nylon, lụa, hoặc các loại sợi tổng hợp, với độ co giãn cao để ôm sát chân, tạo cảm giác thoải mái khi sử dụng.'),
	(155, 'áo lớp', 12000, 'đẹp'),
	(156, 'Áo Khoác Phao Nam, Dày Dặn, Trượt Nước đẹp nhất VN', 2000000, 'Chiếc áo khoác phao chần bông sử dụng chất liệu Poly ứng dụng công nghệ GORE-TEX trượt nước nhẹ, cản gió hiệu quả, giữ nhiệt, ấm áp tức thì. Thiết kế đường chỉ chần cách điệu nổi bật, mũ trùm có chốt cố định, tay áo bo chun dày dặn, có nhám hạn chế gió lùa tối đa; hình in silicon cao cấp khỏe khoắn. Bảng màu đa dạng, thiết kế thông minh, basic dễ mặc phù hợp trong nhiều hoàn cảnh.'),
	(157, 'Áo Khoác Phao Nam, Dày Dặn, Trượt Nước đẹp nhất VN', 2000000, 'Chiếc áo khoác phao chần bông sử dụng chất liệu Poly ứng dụng công nghệ GORE-TEX trượt nước nhẹ, cản gió hiệu quả, giữ nhiệt, ấm áp tức thì. Thiết kế đường chỉ chần cách điệu nổi bật, mũ trùm có chốt cố định, tay áo bo chun dày dặn, có nhám hạn chế gió lùa tối đa; hình in silicon cao cấp khỏe khoắn. Bảng màu đa dạng, thiết kế thông minh, basic dễ mặc phù hợp trong nhiều hoàn cảnh.'),
	(158, 'Áo Khoác Phao Nam, Dày Dặn, Trượt Nước đẹp nhất VN', 2000000, 'Chiếc áo khoác phao chần bông sử dụng chất liệu Poly ứng dụng công nghệ GORE-TEX trượt nước nhẹ, cản gió hiệu quả, giữ nhiệt, ấm áp tức thì. Thiết kế đường chỉ chần cách điệu nổi bật, mũ trùm có chốt cố định, tay áo bo chun dày dặn, có nhám hạn chế gió lùa tối đa; hình in silicon cao cấp khỏe khoắn. Bảng màu đa dạng, thiết kế thông minh, basic dễ mặc phù hợp trong nhiều hoàn cảnh.'),
	(159, 'Áo Khoác Phao Nam, Dày Dặn, Trượt Nước đẹp nhất VN', 2000000, 'Chiếc áo khoác phao chần bông sử dụng chất liệu Poly ứng dụng công nghệ GORE-TEX trượt nước nhẹ, cản gió hiệu quả, giữ nhiệt, ấm áp tức thì. Thiết kế đường chỉ chần cách điệu nổi bật, mũ trùm có chốt cố định, tay áo bo chun dày dặn, có nhám hạn chế gió lùa tối đa; hình in silicon cao cấp khỏe khoắn. Bảng màu đa dạng, thiết kế thông minh, basic dễ mặc phù hợp trong nhiều hoàn cảnh.'),
	(160, 'Tất Nam, Kháng Khuẩn, Khử Mùi , thơm', 100000, 'Tất Nam sử dụng chất liệu Cotton mềm mại, thấm hút mồ tốt, sản phẩm giữ cho đôi chân luôn thoáng mát nên rất phù hợp với những ai thường mang giày cả ngày. Sản phẩm được dệt bo tròn cổ đảm bảo không bị tụt trong suốt quá trình vận động, đi lại.'),
	(161, 'áo đỏ', 100000000, 'áo đẹp'),
	(162, 'áo mát mẻ', 12222222, 'mát mẻ');

-- Dumping data for table datn.productcategory: ~104 rows (approximately)
...
-- Dumping data for table datn.productimage: ~493 rows (approximately)
INSERT INTO `productimage` (`ImageID`, `ProductID`, `ImagePath`) VALUES
	...
	(718, 154, 'https://iili.io/2cSHaeI.png'),
	(719, 155, 'https://iili.io/2lb1UFf.png'),
	(720, 156, 'https://iili.io/2lbS1e9.jpg'),
	(721, 156, 'https://iili.io/2lbSMzu.jpg'),
	(722, 156, 'https://iili.io/2lbSVWb.jpg'),
	(723, 156, 'https://iili.io/2lbSwgV.jpg'),
	(724, 156, 'https://iili.io/2lbSe5P.jpg'),
	(725, 156, 'https://iili.io/2lbS4qv.jpg'),
	(726, 157, 'https://iili.io/2lbS1e9.jpg'),
	(727, 157, 'https://iili.io/2lbSMzu.jpg'),
	(728, 157, 'https://iili.io/2lbSVWb.jpg'),
	(729, 157, 'https://iili.io/2lbSwgV.jpg'),
	(730, 157, 'https://iili.io/2lbSe5P.jpg'),
	(731, 157, 'https://iili.io/2lbS4qv.jpg'),
	(732, 158, 'https://iili.io/2lbS1e9.jpg'),
	(733, 158, 'https://iili.io/2lbSMzu.jpg'),
	(734, 158, 'https://iili.io/2lbSVWb.jpg'),
	(735, 158, 'https://iili.io/2lbSwgV.jpg'),
	(736, 158, 'https://iili.io/2lbSe5P.jpg'),
	(737, 158, 'https://iili.io/2lbS4qv.jpg'),
	(738, 159, 'https://iili.io/2lbS1e9.jpg'),
	(739, 159, 'https://iili.io/2lbSMzu.jpg'),
	(740, 159, 'https://iili.io/2lbSVWb.jpg'),
	(741, 159, 'https://iili.io/2lbSwgV.jpg'),
	(742, 159, 'https://iili.io/2lbSe5P.jpg'),
	(743, 159, 'https://iili.io/2lbS4qv.jpg'),
	(744, 160, 'https://iili.io/2lbgvVa.jpg'),
	(745, 160, 'https://iili.io/2lbgiNt.jpg'),
	(746, 160, 'https://iili.io/2lbrHRS.jpg'),
	(747, 160, 'https://iili.io/2lbrB0x.jpg'),
	(748, 160, 'https://iili.io/2lbrCUQ.jpg'),
	(749, 161, 'https://iili.io/2lb1UFf.png'),
	(750, 162, 'https://iili.io/20dCx1V.png');

-- Dumping data for table datn.productquantity: ~398 rows (approximately)
...
-- Dumping data for table datn.productsize: ~398 rows (approximately)
...
-- Dumping data for table datn.storeinformation: ~1 rows (approximately)
INSERT INTO `storeinformation` (`StoreInformationID`, `Address`, `Hotline`, `Email`, `OpeningHours`, `ClosingHours`, `Facebook`) VALUES
	(7, 'núi thành thành phố đà nẵng ', '0373802903', 'ducbien911@gmail.com', '08:00:00', '23:00:00', '');

-- Dumping data for table datn.users: ~9 rows (approximately)
INSERT INTO `users` (`UserID`, `FullName`, `Email`, `PhoneNumber`, `Gender`, `DateBirthday`, `AvatarPath`, `IsAdmin`, `hashedPassword`, `ForgotPassword`) VALUES
	(1, 'Ngô Đức Biển ', 'ducbien911@gmail.com', '09898989898', 'Nam', '1947-02-13', 'https://iili.io/2cSHaeI.png', 1, '$2a$12$oitCI1Qg9RJii54JHUXO0.sTJMobPxCwhLQ/jcitKG8FU9yzi.mtS', '$2a$10$zG71hXIxXl3HBY1uUzPLYe76KfDS2tVS/9W/xeJsOGPzLzN214GDW'),
	(9, 'khánh', 'khanh@gmail.com', '0373802891', NULL, NULL, 'https://iili.io/J5HMiyG.md.jpg', 0, '$2a$10$KuZxQh.dYCIQq/Vlu2uTSOHREuEvYaliiqS3mOUz8t9O1B3GFvJ1m', NULL),
	(10, 'ngoducbien11', 'bien11@gmail.com', '03738028933', NULL, NULL, 'https://iili.io/J5HMiyG.md.jpg', 0, '$2a$10$NE5eCsWCBULprFGDFTxP5eIHGBBnAji1gySw5Dwn.QZ1NASesTnm2', NULL),
	(11, 'bien', 'bien12@gmail.com', '03738028935', NULL, NULL, 'https://iili.io/J5HMiyG.md.jpg', 0, '$2a$12$zk5VnO.SyMdQlABjq36wSONOEFs5Cfhn6ljyQDk8tkxkyPSdxkeQO\r\n', NULL),
	(12, 'ngoducbien', 'ducbien9112@gmail.com', '037380289333', 'Nam', '1955-10-16', 'https://iili.io/J5HMiyG.md.jpg', 0, '$2a$10$KDp7l5Z5RyaIgUOlcLY6ceZquutruJO73nfkzWbsM0zX1UQ3.ccCW', NULL),
	(14, 'biển biển 1', 'ducbien1911@gmail.com', '037380289311', 'Nam', '1954-08-14', 'https://iili.io/J5HMiyG.md.jpg', 0, '$2a$10$tX4ZDka4cMqs2XyM1c1ChujCYsSLbqGWSo.hPOZqyxF0Nzv2mqFLq', NULL),
	(16, 'bienbien', 'bienbien@gmail.com', '0123456', NULL, NULL, 'https://iili.io/J5HMiyG.md.jpg', 0, '$2a$10$IOtBiWC50OsMK3ZoqA4CDu384J6wK9ibyTFekI.BSNorq3P59rcqm', NULL),
	(17, 'ngoducbien1', 'bien_20512200200@dau.edu.vn', '037380289334', NULL, NULL, 'https://iili.io/J5HMiyG.md.jpg', 0, '$2a$10$XlAKB5SJcnNu5ct2rrDpV.dm6CP088/y1E0F8ESf.CLeD9faEFHnK', NULL),
	(19, 'a', 'a@gmail.com', '12345', NULL, NULL, 'https://iili.io/J5HMiyG.md.jpg', 1, '$2a$10$WhTKwqqEYBhP/WPWa28u2OYt0DDP50Xg1YXlhvSDo75c0QC7PuNA6', NULL);
